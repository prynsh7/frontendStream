                ...
                <div className="flex flex-col justify-between h-full">
                    <div>
                        <div className="lg:flex w-full justify-between">
                            <h3 className="text-gray-600 dark:text-gray-400 leading-5 text-base md:text-xl font-bold">Views Per Country</h3>
                    ...
                    <div className="mt-6">
                        <Chart chartType="GeoChart" options={options} width="100%" height="400px" data={data} />
                    </div>
                </div>
            </div>
        </div>
