        ...
        <nav className="bg-[#161616] border-gray-200 px-2 sm:px-4 py-2.5 rounded lg:px-[40px] md:pt-12">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="flex justify-between gap-4 md:gap-8 items-center md:order-2">
                    ...
                    <button className="text-white font-medium bg-gradient-to-r from-[#9A3EBF] via-[#C53660, #E93141] to-[#F98B51] rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 med-font" onClick={() => navigate("/signin")} >Sign In</button>
                </div>
