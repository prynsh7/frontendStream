            ...
            <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-2xl">
                <div className="relative py-8 px-5 md:px-12 bg-white shadow-md rounded border border-gray-400">
                    ...
                    <div className="flex justify-between">
                        <div className="w-[120px] h-[84px] relative"><img src='./Assets/space.png' className="absolute object-fill" alt="space" layout="fill" /></div>
                        <div className="w-[120px] h-[84px] relative"><img src='./Assets/rocket.png' className="absolute object-fill" alt="rocket" layout="fill" /></div>
                        <div className="w-[120px] h-[84px] relative"><img src='./Assets/rocket.png' className="absolute object-fill" alt="rocket" layout="fill" /></div>
                    </div>
